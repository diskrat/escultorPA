...
QT_MOC_LITERAL(1, 8, 15), // "signalMousePosX"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 15) // "signalMousePosY"

    },
    "Plotter\0signalMousePosX\0\0signalMousePosY"
};
...
void Plotter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalMousePosX((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->signalMousePosY((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Plotter::signalMousePosX)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Plotter::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Plotter::signalMousePosY)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Plotter::signalMousePosX(int _t1)
{
...
// SIGNAL 1
void Plotter::signalMousePosY(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
